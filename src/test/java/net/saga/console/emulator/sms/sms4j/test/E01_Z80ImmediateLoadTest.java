...
public class E01_Z80ImmediateLoadTest {
    ...
    public void test8bitRegisterLoadInstructions() {
        Z80 z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x06, 0xFF, 0xFF}); //Load into B value 0xFF
        z80.cycle(7);
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x16, 0xEF, 0xFF}); //Load into D value 0xFF
        z80.cycle(7);
        Assert.assertEquals(2, z80.getPC());
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x26, 0xFA, 0xFF}); //Load into F value 0xFA
        z80.cycle(7);
        Assert.assertEquals(2, z80.getPC());
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x0E, 0x7D, 0xFF}); //Load into C value 0x7D
        z80.cycle(7);
        Assert.assertEquals(2, z80.getPC());
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x1E, 0x01, 0xFF}); //Load into E value 0x01
        z80.cycle(7);
        Assert.assertEquals(2, z80.getPC());
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x2E, 0xBD, 0xFF}); //Load into L value 0xBD
        z80.cycle(7);
        Assert.assertEquals(2, z80.getPC());
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x3E, 0x98, 0xFF}); //Load into A value 0x98
        z80.cycle(7);
        Assert.assertEquals(2, z80.getPC());
    ...
    public void test16bitRegisterLoadInstructions() {
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x11, 0xEF, 0xFE}); //Load into DE value 0xEFFE
        z80.cycle(10);
        Assert.assertEquals(3, z80.getPC());
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x21, 0x0D, 0xDF}); //Load into HL value 0x0DDF
        z80.cycle(10);
        Assert.assertEquals(3, z80.getPC());
        ...
        z80 = new Z80();
        z80.setPC(0);
        z80.setMemory(new int[]{0x31, 0x0D, 0xD0}); //Load into SP value 0x0DD0
        z80.cycle(10);
        Assert.assertEquals(3, z80.getPC());
