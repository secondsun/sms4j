 ...
 * @author summers
 */
public class DecrementRegisterInstructionSixteenBit implements InstructionExecution {

    private final Register<Short> register;
    private final Z80 z80;

    public DecrementRegisterInstructionSixteenBit(Register<Short> register, Z80 z80) {
